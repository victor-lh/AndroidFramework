 ...
 * 17/12/2018
 */
public abstract class AbstractViewHolderDraggableChild<ICL extends ItemChildLista> extends AbstractViewHolderChild<ICL> implements DraggableItemViewHolder {

	private final DraggableItemState mDragState = new DraggableItemState();
	public AbstractViewHolderDraggableChild(View itemView) {
		super(itemView);
	}
