 ...
 * 17/12/2018
 */
public abstract class AbstractViewHolderDraggableGroup<IGL extends ItemGroupLista<ICL>, ICL extends ItemChildLista> extends AbstractViewHolderGroup<IGL, ICL> implements DraggableItemViewHolder {

	private final DraggableItemState mDragState = new DraggableItemState();

	public AbstractViewHolderDraggableGroup(View itemView) {
		super(itemView);
	}
