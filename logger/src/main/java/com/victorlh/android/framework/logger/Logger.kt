...
object Logger {
    ...
    fun registrarObserver(observer: LoggerObserver) {
        observers.add(observer)
    }

    fun suprimirObserver(observer: LoggerObserver) {
        observers.remove(observer)
    }

    fun trace(@Size(max = 23) tag: String, mensaje: String) {
        trace(tag, mensaje, null)
    }

    fun trace(@Size(max = 23) tag: String, e: Throwable) {
        log(NivelLogImpl.TRACE, tag, e)
    }

    fun trace(@Size(max = 23) tag: String, mensaje: String, e: Throwable?) {
        log(NivelLogImpl.TRACE, tag, mensaje, e)
    }

    fun debug(@Size(max = 23) tag: String, mensaje: String) {
        debug(tag, mensaje, null)
    }

    fun debug(@Size(max = 23) tag: String, e: Throwable) {
        log(NivelLogImpl.DEBUG, tag, e)
    }

    fun debug(@Size(max = 23) tag: String, mensaje: String, e: Throwable?) {
        log(NivelLogImpl.DEBUG, tag, mensaje, e)
    }

    fun info(@Size(max = 23) tag: String, mensaje: String) {
        info(tag, mensaje, null)
    }

    fun info(@Size(max = 23) tag: String, e: Throwable) {
        log(NivelLogImpl.INFO, tag, e)
    }

    fun info(@Size(max = 23) tag: String, mensaje: String, e: Throwable?) {
        log(NivelLogImpl.INFO, tag, mensaje, e)
    }

    fun warn(@Size(max = 23) tag: String, mensaje: String) {
        warn(tag, mensaje, null)
    }

    fun warn(@Size(max = 23) tag: String, e: Throwable) {
        log(NivelLogImpl.WARN, tag, e)
    }

    fun warn(@Size(max = 23) tag: String, mensaje: String, e: Throwable?) {
        log(NivelLogImpl.WARN, tag, mensaje, e)
    }

    fun error(@Size(max = 23) tag: String, mensaje: String) {
        error(tag, mensaje, null)
    }

    fun error(@Size(max = 23) tag: String, e: Throwable) {
        log(NivelLogImpl.ERROR, tag, e)
    }

    fun error(@Size(max = 23) tag: String, mensaje: String, e: Throwable?) {
        log(NivelLogImpl.ERROR, tag, mensaje, e)
    }
